...
export default function Donate() {
  ...
  return (
    <>
      <Head>
        <title>Donate | ZenTrust</title>
        <meta name="description" content={seoDescription} />
        <link rel="canonical" href="https://www.zentrust.world/donate" />
        <meta
          property="og:title"
          content="Donate to ZenTrust | Regenerative Agriculture & Holistic Wellness"
        />
        <meta property="og:description" content={seoDescription} />
        <meta property="og:url" content="https://www.zentrust.world/donate" />
      ...
      <main className="min-h-screen bg-black text-white px-4 py-12 flex flex-col items-center">
        <div className="w-full max-w-3xl space-y-8">
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-3 bg-gray-900 rounded-xl p-5">
              <h3 className="text-xl font-semibold">
                2. Bank Transfer / Check (By Request)
              </h3>
              <p className="text-gray-300 text-sm sm:text-base">
          ...
          <footer className="text-xs text-gray-400 border-t border-gray-800 pt-4 mt-6">
            <p>
              ZenTrust, Inc. is a federally recognized 501(c)(3) public
              charity. EIN: 33-4318487. Contributions are tax-deductible to the
