...
export default function Zenboard({ uid }) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black text-white">
      ...
      <div className="absolute top-16 w-full text-center z-20">
        <div className="text-xl sm:text-2xl md:text-3xl font-semibold text-white drop-shadow-lg">
          🌱 What lights you up?
        </div>
      </div>
      ...
      <div className="absolute top-3 right-4 text-right z-20">
        <div className="text-xs opacity-70">You belong — exactly as you are.</div>
        <MoonSync />
      </div>
